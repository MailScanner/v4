Summary: Digest-MD5 Perl module
...
Source0: Digest-MD5-2.36.tar.gz
...
Digest-MD5 Perl module
%prep
%setup -q -n Digest-MD5-%{version} 1
...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Digest-MD5-%{version}-filelist
if [ "$(cat Digest-MD5-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Digest-MD5-%{version}-filelist
%defattr(-,root,root)
