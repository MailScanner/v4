...
Source0: Pod-Simple-3.05.tar.gz

%description
Pod-Simple Perl module

%description
Pod-Simple Perl module
%prep
%setup -q -n Pod-Simple-%{version} 1
...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Pod-Simple-%{version}-filelist
if [ "$(cat Pod-Simple-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Pod-Simple-%{version}-filelist
%defattr(-,root,root)
