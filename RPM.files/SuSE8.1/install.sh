...
BASEPACKAGES="binutils gcc glibc-devel libaio1 make man-pages patch rpm tar time unzip which zip libtool perl curl wget openssl bzip2 tnef unrar razor-agents";
...
$ZYPPER --non-interactive install $BASEPACKAGES $MTAOPTION
