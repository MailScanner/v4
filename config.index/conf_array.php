...
Archive Mail = /var/spool/MailScanner/archive',
 ...
 This can also be the filename of a ruleset.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/deleted.content.message.txt',
 ...
 These can also be the filenames of rulesets.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/deleted.filename.message.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/deleted.size.message.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/deleted.virus.message.txt',
 ...
 This can also be the filename of a ruleset.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/disinfected.report.txt',
...
',
 ...
 This can also be the filename of a ruleset.',
    'value' => ' Please contact the ISP for more information',
  ),
  'inlinehtmlsig' => 
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/inline.sig.html',
 ...
 These can also be the filenames of rulesets.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/inline.warning.html',
 ...
 These can also be the filenames of rulesets.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/inline.spam.warning.txt',
 ...
 the top of the message.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/inline.sig.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/inline.warning.txt',
...
',
 ...
 Note: If you enable this feature, set "bayes_auto_expire 0" in
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/recipient.mcp.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/recipient.spam.report.txt',
 ...
 original recipients of the message.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/message.rejection.report.txt',
...
Run As User = postfix',
 ...
 This can also be the filename of a ruleset.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.content.report.txt',
 ...
 These can also be the filenames of rulesets.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.filename.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.error.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.mcp.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.size.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.spam.sa.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.spam.rbl.report.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.spam.report.txt',
 ...
 These can also be the filenames of rulesets.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/sender.virus.report.txt',
...
SpamAssassin User State Dir = /var/spool/MailScanner/spamassassin',
 ...
 Example:  SQL SpamAssassin Config = SELECT text FROM sa_config',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/stored.content.message.txt',
 ...
 These can also be the filenames of rulesets.',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/stored.filename.message.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/stored.size.message.txt',
  ...
  array (
    ...
    'type' => 'file',
    'ruleset' => 'first',
    'default' => '/etc/MailScanner/reports/en/stored.virus.message.txt',
...
TNEF Expander  = internal',
 ...
 Thi can also be the filename of a ruleset.',
  ...
  array (
    ...
    'type' => 'other',
    'ruleset' => 'first',
    'default' => 'http://www.mailscanner.info/images/1x1spacer.gif',
 ...
 This can also be the filename of a ruleset.',
    'value' => ' http://www.mailscanner.tv/1x1spacer.gif',
  ),
  'addenvfrom' => 
  array (
