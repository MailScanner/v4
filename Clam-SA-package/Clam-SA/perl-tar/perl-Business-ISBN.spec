...
Source0: Business-ISBN-1.82.tar.gz
...
Business-ISBN Perl module
%prep
%setup -q -n Business-ISBN-%{version} 1
...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Business-ISBN-%{version}-filelist
if [ "$(cat Business-ISBN-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Business-ISBN-%{version}-filelist
%defattr(-,root,root)
