...
Source0: Crypt-OpenSSL-RSA-0.26.tar.gz
...
Crypt-OpenSSL-RSA Perl module
%prep
%setup -q -n Crypt-OpenSSL-RSA-%{version} 1
...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Crypt-OpenSSL-RSA-%{version}-filelist
if [ "$(cat Crypt-OpenSSL-RSA-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Crypt-OpenSSL-RSA-%{version}-filelist
%defattr(-,root,root)
