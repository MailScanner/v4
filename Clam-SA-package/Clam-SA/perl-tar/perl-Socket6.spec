...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Socket6-%{version}-filelist
if [ "$(cat Socket6-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Socket6-%{version}-filelist
%defattr(-,root,root)
