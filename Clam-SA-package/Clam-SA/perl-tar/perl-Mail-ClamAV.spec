Summary: Mail-ClamAV Perl module
...
Source0: Mail-ClamAV-0.22.tar.gz
...
Mail-ClamAV Perl module
%prep
%setup -q -n Mail-ClamAV-%{version} 1
...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Mail-ClamAV-%{version}-filelist
if [ "$(cat Mail-ClamAV-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Mail-ClamAV-%{version}-filelist
%defattr(-,root,root)
