...
Source0: Archive-Tar-1.29.tar.gz

%description
Archive-Tar Perl module

%description
Archive-Tar Perl module
%prep
%setup -q -n Archive-Tar-%{version} 1
...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > Archive-Tar-%{version}-filelist
if [ "$(cat Archive-Tar-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f Archive-Tar-%{version}-filelist
%defattr(-,root,root)
