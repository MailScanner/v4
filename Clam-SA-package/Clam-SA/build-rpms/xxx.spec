...
find $RPM_BUILD_ROOT/usr -type f -print | \
	...
	grep -v "\.packlist" > xxx-%{version}-filelist
if [ "$(cat xxx-%{version}-filelist)X" = "X" ] ; then
    echo "ERROR: EMPTY FILE LIST"
    exit 1
fi

%files -f xxx-%{version}-filelist
%defattr(-,root,root)
